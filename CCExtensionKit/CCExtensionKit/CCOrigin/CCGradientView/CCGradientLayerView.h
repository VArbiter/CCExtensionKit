...
- (void) ccBeginWith : (CGPoint) pBegin // the point that gradient begins . (CGPoint){[0,1],[0,1]} // 渐变从哪开始
        ...
        eachPercents : (NSArray <NSNumber *> *(^)(void)) percents ;// each color holds the percent of the gradient area . [0..1] // 比例数组
