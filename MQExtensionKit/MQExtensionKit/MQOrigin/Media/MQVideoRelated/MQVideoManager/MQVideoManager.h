...
@class MQVideoInfoEntity , MQVideoManager ;


@protocol MQVideoManagerDelegate < NSObject >

@required
- (void) mq_video_manager : (MQVideoManager *)manager
...
@interface MQVideoManager : NSObject

@property (nonatomic , assign) id <MQVideoManagerDelegate> delegate ;
...
@interface MQVideoInfoEntity : NSObject
