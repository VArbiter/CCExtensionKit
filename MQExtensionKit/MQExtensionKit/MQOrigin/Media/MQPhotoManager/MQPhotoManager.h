...
- (NSMutableArray <NSDictionary <NSString * , id> *> *) mq_get_images_page : (NSInteger) i_page ;

/// get image data for specific asset .// 根据 asset 获得特定 的图片数据
- (void) mq_get_image_data : (PHAsset *) asset
                  complete : (void(^)(NSData *image_data , BOOL is_can_be_used)) mq_complete_block ;
...
FOUNDATION_EXPORT NSString * mq_photo_manger_image_key ;
FOUNDATION_EXPORT NSString * mq_photo_manger_info_key ;
FOUNDATION_EXPORT NSString * mq_photo_manger_video_key ;
FOUNDATION_EXPORT NSString * mq_photo_manger_unknow_key ;

FOUNDATION_EXPORT NSString * mq_photo_manger_type_key ;
FOUNDATION_EXPORT NSString * mq_photo_manger_asset_key ;
