...
/// regist event . // 注册事件
FOUNDATION_EXPORT CCPointMarkerEventKey mq_point_marker_track_regist_event_key ;
/// login event . // 登录事件
FOUNDATION_EXPORT CCPointMarkerEventKey mq_point_marker_track_login_event_key ;
/// logout event . // 登出事件
FOUNDATION_EXPORT CCPointMarkerEventKey mq_point_marker_track_logout_event_key ;
/// begin track a page . // 开始记录页面
FOUNDATION_EXPORT CCPointMarkerEventKey mq_point_marker_track_page_begin_event_key ;
/// end track a page . // 结束记录界面
FOUNDATION_EXPORT CCPointMarkerEventKey mq_point_marker_track_page_end_event_key ;
/// track app active times . // 记录应用重新进入前台次数
FOUNDATION_EXPORT CCPointMarkerEventKey mq_point_marker_track_app_active_event_key ;
/// track app resign active times . // 记录应用从前台退出次数
FOUNDATION_EXPORT CCPointMarkerEventKey mq_point_marker_track_app_resign_active_event_key ;
/// track users' location . // 记录用户的地址
FOUNDATION_EXPORT CCPointMarkerEventKey mq_point_marker_track_location_event_key ;
...
- (void) mq_point_maker : (CCPointMarker *) marker
...
/// only worked when invoke "[CCPointMarker mq_enable_logging_to_local_file]"
// 只有在 调用 "[CCPointMarker mq_enable_logging_to_local_file]"时 起效
- (void) mq_point_maker : (CCPointMarker *) marker
...
/// channel . // 发布渠道
FOUNDATION_EXPORT CCMarkerEventDefaultExtraInfoKey mq_event_default_info_channel_key ;
/// is debug or not . // 是否是开发环境
FOUNDATION_EXPORT CCMarkerEventDefaultExtraInfoKey mq_event_default_info_debug_key ;
/// event id . // 事件 id
FOUNDATION_EXPORT CCMarkerEventDefaultExtraInfoKey mq_event_default_info_event_id_key ;
/// event type . // 事件类型
FOUNDATION_EXPORT CCMarkerEventDefaultExtraInfoKey mq_event_default_extra_info_type_key ;
/// extra info . // 额外信息 .
FOUNDATION_EXPORT CCMarkerEventDefaultExtraInfoKey mq_event_default_extra_info_extra_key ; // for developer // 针对开发者
/// extra default info . // 额外默认信息 .
FOUNDATION_EXPORT CCMarkerEventDefaultExtraInfoKey mq_event_default_extra_info_extra_default_key ;
/// method that record event . // 用来记录事件的方法
FOUNDATION_EXPORT CCMarkerEventDefaultExtraInfoKey mq_event_default_extra_info_method_key ;
/// description for this event . // 这个事件的描述
FOUNDATION_EXPORT CCMarkerEventDefaultExtraInfoKey mq_event_default_extra_info_description_key ;

// ------

/// common event type . // 公共事件类型
FOUNDATION_EXPORT CCMarkerEventDefaultExtraInfoKey mq_event_default_extra_info_type_common_key ;
/// count event type . // 计数事件类型
FOUNDATION_EXPORT CCMarkerEventDefaultExtraInfoKey mq_event_default_extra_info_type_count_key ;
///  calculate event type . // 计算事件类型
FOUNDATION_EXPORT CCMarkerEventDefaultExtraInfoKey mq_event_default_extra_info_type_calculate_key ;

/// iPhone or iPad app . // iPhone 或 iPad 应用
FOUNDATION_EXPORT CCMarkerEventDefaultExtraInfoKey mq_event_default_extra_info_source_key ;
/// app bundle id .// 应用的 bundle id
FOUNDATION_EXPORT CCMarkerEventDefaultExtraInfoKey mq_event_default_extra_info_bundle_id_key ;
/// app developer team (need to be specified by developer).// 应用的开发团队 (开发者自己指定)
FOUNDATION_EXPORT CCMarkerEventDefaultExtraInfoKey mq_event_default_extra_info_develop_team_key ;
/// event occurrence time . // 事件发生时间
FOUNDATION_EXPORT CCMarkerEventDefaultExtraInfoKey mq_event_default_extra_info_occurrence_time_key ;
/// event time stamp. // 事件时间戳
FOUNDATION_EXPORT CCMarkerEventDefaultExtraInfoKey mq_event_default_extra_info_time_stamp_key ;
/// device uuid .// 设备 uuid
FOUNDATION_EXPORT CCMarkerEventDefaultExtraInfoKey mq_event_default_extra_info_UUID_key ;
/// device idfa .// 设备的 IDFA
FOUNDATION_EXPORT CCMarkerEventDefaultExtraInfoKey mq_event_default_extra_info_IDFA_key ;
/// system version .// 系统版本号
FOUNDATION_EXPORT CCMarkerEventDefaultExtraInfoKey mq_event_default_extra_info_system_version_key ;
/// device info .// 设备信息 eg : iPhone 8,1
FOUNDATION_EXPORT CCMarkerEventDefaultExtraInfoKey mq_event_default_extra_info_device_info_key ;
/// app version .// 应用版本
FOUNDATION_EXPORT CCMarkerEventDefaultExtraInfoKey mq_event_default_extra_info_version_key ;
/// build version. // 构建版本
FOUNDATION_EXPORT CCMarkerEventDefaultExtraInfoKey mq_event_default_extra_info_build_version_key ;
/// current memory .// 当前使用内存
FOUNDATION_EXPORT CCMarkerEventDefaultExtraInfoKey mq_event_default_extra_current_memory_key ;
/// memory remain . // 当前剩余内存
FOUNDATION_EXPORT CCMarkerEventDefaultExtraInfoKey mq_event_default_extra_memory_remain_key ;

// ------

/// user id . // 用户 id
FOUNDATION_EXPORT CCMarkerEventDefaultExtraInfoKey mq_event_default_extra_info_account_id_key ;
/// latitude // 经度
FOUNDATION_EXPORT CCMarkerEventDefaultExtraInfoKey mq_event_default_extra_info_latitude_key ;
/// longitude // 纬度
FOUNDATION_EXPORT CCMarkerEventDefaultExtraInfoKey mq_event_default_extra_info_longitude_key ;
/// app active status // 应用活跃状态
FOUNDATION_EXPORT CCMarkerEventDefaultExtraInfoKey mq_event_default_extra_info_app_active_key ;
/// app resign active status // 应用不活跃状态
FOUNDATION_EXPORT CCMarkerEventDefaultExtraInfoKey mq_event_default_extra_info_app_resign_active_key ;
/// the page that before entering a new page .  // 进入特定界面之前的一个界面
FOUNDATION_EXPORT CCMarkerEventDefaultExtraInfoKey mq_event_default_extra_info_page_previous_key ;
/// the page that current in front . // 应用进入页面
FOUNDATION_EXPORT CCMarkerEventDefaultExtraInfoKey mq_event_default_extra_info_page_begin_key ;
/// user leave a page .// 应用从特定页面退出
FOUNDATION_EXPORT CCMarkerEventDefaultExtraInfoKey mq_event_default_extra_info_page_end_key ;
/// how long app in use before it has been destroyed . (millseconds) // 在应用被销毁前使用了多久 (毫秒)
FOUNDATION_EXPORT CCMarkerEventDefaultExtraInfoKey mq_event_default_extra_info_app_total_use_time_key ;
/// how long user stay in this page . (millseconds) // 用户在这个页面待了多久 (毫秒)
FOUNDATION_EXPORT CCMarkerEventDefaultExtraInfoKey mq_event_default_extra_info_page_use_time_key ;
/// the sequence that entering the page . // 用户进入界面序列
FOUNDATION_EXPORT CCMarkerEventDefaultExtraInfoKey mq_event_default_extra_info_page_sequence_key ;
